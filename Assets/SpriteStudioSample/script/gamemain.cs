		...
		for ( i = 0; i < COLLISION_MAX; i++ )
		{
			...
			if ( collision[i].life > 0 )
			{
				...
				case COLTYPE.EN_COLTYPE_PLAYER:
					coldisp[i].GetComponent<Renderer>().material.color = Color.blue;
					break;
				case COLTYPE.EN_COLTYPE_PLAYER_SHOT:
					coldisp[i].GetComponent<Renderer>().material.color = Color.yellow;
					break;
				case COLTYPE.EN_COLTYPE_ENEMY:
					coldisp[i].GetComponent<Renderer>().material.color = Color.red;
					break;
				case COLTYPE.EN_COLTYPE_ENEMY_SHOT:
					coldisp[i].GetComponent<Renderer>().material.color = Color.green;
					break;
				}
